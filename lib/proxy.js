...
exports.processRewrites = function (options) {
    ...
    Object.keys(rewrites).forEach(function (from) {
        ...
        if (exports.validateRewrite(rule)) {
            ...
            rules.push(rule);
            exports.logger.log(' ', 'Rewrite [' + from + ' -> ' + rule.to + ']');
        } else {
            exports.logger.error('Invalid rule');
        }
    });
...
exports.config = function(proxies){
    ...
    proxies.forEach(function(option) {
        ...
        if (!proxyOption.location) {
            return exports.logger.error('Proxy missing location configuration');
        ...
        exports.logger.log( 'proxy', 'Route [' + proxyOption.location + " -> " + (proxyOption.host || proxyOption.file || proxyOption.root || proxyOption.alias) + ']' );
    });
}
